...
# Get Chrome Browser Location
# options = Options()
# options.binary_location = "C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe"

# Access to Twitter
url = "https://twitter.com/login"
# driver = webdriver.Chrome(options=options, executable_path="D:\\Software\\Developer\\msedgedriver.exe")
driver = webdriver.Firefox(executable_path="D:\\Software\\Developer\\geckodriver.exe") # Firefox
driver.get(url)

# Find login box
waiting_func('class name', 'js-signin-email')
email = driver.find_element_by_class_name('session[username_or_email]')
email.send_keys('')
